...
import 'package:bxmap_flutter/base/poi.dart';
...
///定位回调接口
class LocationChangedEvent extends MapEvent<BXMapLocation> {
  LocationChangedEvent(int mapId, BXMapLocation value) : super(mapId, value);
}
